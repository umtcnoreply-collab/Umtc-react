...
function PreviewPage() {
  ...
  if (loading) {
    return (
      <div className="bg-[#f0f8ff] text-[#1c1c19] font-['Inter'] min-h-screen flex flex-col items-center justify-center">
        <div className="text-center">
          <div className="inline-block mb-4">
            <span className="material-symbols-outlined text-5xl text-[#324670] animate-spin">hourglass_bottom</span>
          </div>
          <p className="text-lg font-semibold text-[#324670]">Loading your application...</p>
        </div>
      </div>
    );
  }
  ...
  if (error || !formData) {
    return (
      <div className="bg-[#f0f8ff] text-[#1c1c19] font-['Inter'] min-h-screen flex flex-col items-center justify-center px-4">
    ...
    <div className="bg-[#f0f8ff] text-[#1c1c19] font-['Inter'] min-h-screen flex flex-col">
      ...
      <div className="md:hidden flex-grow pt-24 pb-32 px-6 max-w-md mx-auto w-full">
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="bg-[#f0f8ff] rounded-xl p-6 space-y-4 shadow-sm border border-[#e5e2dd]">
              <div className="grid grid-cols-1 gap-1">
                <label className="text-[10px] font-bold text-[#324670] uppercase tracking-wider">Candidate Name</label>
                <p className="text-[#1c1c19] font-medium">{formData?.candidateName || 'N/A'}</p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Mobile Number</label><p className="text-[#1c1c19] font-medium text-sm">{formData?.mobile || 'N/A'}</p></div>
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Email Address</label><p className="text-[#1c1c19] font-medium text-sm break-all">{formData?.email || 'N/A'}</p></div>
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Date of Birth</label><p className="text-[#1c1c19] font-medium text-sm">{formatDate(formData?.dob) || 'N/A'}</p></div>
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Gender</label><p className="text-[#1c1c19] font-medium text-sm capitalize">{formData?.gender || 'N/A'}</p></div>
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Nationality</label><p className="text-[#1c1c19] font-medium text-sm capitalize">{formData?.nationality || 'N/A'}</p></div>
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Category</label><p className="text-[#1c1c19] font-medium text-sm uppercase">{formData?.category || 'N/A'}</p></div>
              </div>
            </div>
          </section>
            ...
            <div className="bg-[#f0f8ff] rounded-xl p-6 space-y-4 shadow-sm border border-[#e5e2dd]">
              ...
              <div className="pt-2 border-t border-[#e5e2dd]">
                ...
                <div className="grid grid-cols-2 gap-4 mt-2">
                  <div><label className="text-[10px] font-bold text-[#324670] uppercase">State</label><p className="text-[#1c1c19] font-medium text-sm">{formData?.address?.permanentAddress?.state || 'N/A'}</p></div>
                  <div><label className="text-[10px] font-bold text-[#324670] uppercase">Pin Code</label><p className="text-[#1c1c19] font-medium text-sm">{formData?.address?.permanentAddress?.pincode || 'N/A'}</p></div>
                  <div><label className="text-[10px] font-bold text-[#324670] uppercase">City</label><p className="text-[#1c1c19] font-medium text-sm">{formData?.address?.permanentAddress?.city || 'N/A'}</p></div>
                  <div><label className="text-[10px] font-bold text-[#324670] uppercase">District</label><p className="text-[#1c1c19] font-medium text-sm">{formData?.address?.permanentAddress?.district || 'N/A'}</p></div>
                </div>
              </div>

              <div className="pt-2 border-t border-[#e5e2dd] grid grid-cols-2 gap-4">
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Debarred?</label><p className="text-[#1c1c19] font-medium text-sm">{formatBool(formData?.basicDetails?.debarred)}</p></div>
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">FIR Cases?</label><p className="text-[#1c1c19] font-medium text-sm">{formatBool(formData?.basicDetails?.fir)}</p></div>
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Govt Employee?</label><p className="text-[#1c1c19] font-medium text-sm">{formatBool(formData?.basicDetails?.govt_emp)}</p></div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-[#f0f8ff] rounded-xl p-4 space-y-4 shadow-sm border border-[#e5e2dd]">
              ...
              <div className="border-t border-[#e5e2dd] pt-4">
                <label className="text-[10px] font-bold text-[#324670] uppercase mb-3 block">Educational Qualifications</label>
          ...
          <section>
            <h2 className="font-['Public_Sans'] font-bold text-lg text-[#324670] tracking-wide mb-4 sticky top-20 bg-[#f0f8ff] py-2 z-10">Identification & Status</h2>
            <div className="bg-[#f0f8ff] rounded-xl p-6 space-y-4 shadow-sm border border-[#e5e2dd]">
              <div className="grid grid-cols-2 gap-4">
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Aadhar Number</label><p className="text-[#1c1c19] font-medium text-sm">{formData?.basicDetails?.aadhar || 'N/A'}</p></div>
                <div><label className="text-[10px] font-bold text-[#324670] uppercase">Ex-ServiceMen?</label><p className="text-[#1c1c19] font-medium text-sm">{formatBool(formData?.basicDetails?.exServicemen)}</p></div>
              </div>
              <div className="pt-2 border-t border-[#e5e2dd]">
                <label className="text-[10px] font-bold text-[#324670] uppercase mb-3 block">Visible Identification Marks</label>
                <div className="space-y-2">
                  {formData?.basicDetails?.visibleMarks && formData.basicDetails.visibleMarks.length > 0 ? (
                    formData.basicDetails.visibleMarks.map((mark: string, index: number) => (
                      <p key={index} className="text-sm font-medium text-[#324670] p-2 bg-[#f0f8ff] rounded border border-[#e5e2dd]">{mark || 'N/A'}</p>
                    ))
                  ) : (
          ...
          <section>
            <h2 className="font-['Public_Sans'] font-bold text-lg text-[#324670] tracking-wide mb-4 sticky top-20 bg-[#f0f8ff] py-2 z-10">Application Declarations</h2>
            <div className="bg-[#f0f8ff] rounded-xl p-6 space-y-6 shadow-sm border border-[#e5e2dd] text-sm text-[#324670]">
              <div className="space-y-2">
                <h3 className="font-bold text-[#324670]">Submission Acknowledgment</h3>
        ...
        <div className="mt-12 space-y-4">
          <button onClick={() => setShowModal(true)} className="w-full py-4 bg-[#324670] text-white font-bold rounded-xl shadow-lg flex items-center justify-center gap-2 active:scale-95 transition-all">
                ...
                <div className="bg-[#f0f8ff] p-8 rounded-xl border border-[#e8f4ff] space-y-8">
                  ...
                  <div className="pt-6 border-t border-[#e8f4ff]">
                    ...
                    <div className="space-y-2">
                      {formData?.basicDetails?.visibleMarks && formData.basicDetails.visibleMarks.length > 0 ? (
                        formData.basicDetails.visibleMarks.map((mark: string, index: number) => (
                          <p key={index} className="text-base font-medium text-[#324670] p-2 bg-[#f0f8ff] rounded border border-[#e5e2dd]">{mark || 'N/A'}</p>
                        ))
                      ) : (
